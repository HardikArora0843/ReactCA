        ...
        {cart && cart?.length > 0 ? (<>
            ...
            <div className="bg-zinc800 rounded-t-[60px] w-full h-[35%] flex flex-col items-center px-4 py-6  gap-8 ">
              <div className="w-full flex items-center justify-evenly ">
                ...
                <p className="text-3xl text-orange500 font-semibold flex items-center justify-center gap-1">
              ...
              <motion.button
                {...buttonClick}
                className="bg-orange400  flex items-center justify-center w-[70%]  px-4 py-3 text-xl text-headingColor font-semibold hover:bg-orange500 drop-shadow-md rounded-2xl "
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-start gap-1 w-full">
                    ...
                    <p className="text-sm flex items-center justify-center gap-1 font-semibold text-red4 ml-auto">
                        <HiCurrencyRupee className="text-red4" /> {itemTotal}
                    </p>
            </div>
