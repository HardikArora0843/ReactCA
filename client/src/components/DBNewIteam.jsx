        ...
        />
          <div className='w-full flex items-center justify-around gap-3 flex-wrap  '>
            {statuses && statuses.map(data => (
              ...
              className={`px-4 py-3 rounded-md text-xl text-textColor font-semibold cursor-pointer hover:shadow-md border border-gray2 backdrop-blur-md ${data.category===category ? "bg-red4 text-primary" : "bg-transparent"}`}
              >
                {data.title}
                ...
                {Math.round(progress > 0) && (
                  <div className='w-full flex flex-col items-center justify-center gap-2' >
                    ...
                    <div className='w-full bg-gray2 rounded-full h-2.5'> 
                      <div className='bg-red6 h-2.5 rounded-full transition-all duration-300 ease-in-out'
          ...
          <motion.button
            ...
            {...buttonClick}
            className='w-9/12 py-2 rounded-md bg-red4 text-primary hover:bg-red5 cursor-pointer'
            >
              Save
