      ...
      {/* Background image */}
        ...
        <div className="flex flex-col items-center  bg-lightOverlay w-[50%] md:w-[400px] h-screen z-10 backdrop-blur-md p-4 px-4 py-12 gap-6"> 
            <div className="flex items-center justify-start gap-4 w-full">
                ...
                <p className='text-headingColor font-semibold text-2xl'>Grocer</p>
            </div>
            ...
            <div className="w-full flex flex-col items-center gap-6 px-4 md:px-12 py-4">
              ...
              :(
                ...
                {isSignUp ?
                (<motion.button {...buttonClick}
                  className='w-full p-2 rounded-lg text-xl text-primary bg-red-400 cursor-pointer  bg-red5 transition-all duration-150'
